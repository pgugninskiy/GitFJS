...
// Это задание тоже выполнено неверно. Нет дочерних классов, не используется конструктор класса при создании экземпляров и т.д. Попробуйте разобрать решение предыдущего задания, которое я написала, и на его основе сделать работу над ошибками и исправить это задание